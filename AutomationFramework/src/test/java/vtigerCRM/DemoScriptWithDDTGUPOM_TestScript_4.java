...
public class DemoScriptWithDDTGUPOM_TestScript_4 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		//Select Energy from industry DropDown
		wutil.toHandleDropDown(corg.getIndustryDropDown(),"Energy");
		//Select Customer from Type DropDown
		wutil.toHandleDropDown("Customer",corg.getTypeDropDown());
		//save and verify
