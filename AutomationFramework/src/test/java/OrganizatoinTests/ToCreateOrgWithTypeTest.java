...
public class ToCreateOrgWithTypeTest extends BaseClass{
	...
	public void toCreateOrgWithType() throws EncryptedDocumentException, IOException {
		...
		wutil.toHandleDropDown(cog.getIndustryDropDown(),10);
		wutil.toHandleDropDown("Customer",cog.getTypeDropDown());
